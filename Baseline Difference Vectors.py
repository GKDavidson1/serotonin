...
def parse_args():
    ...
    #     py -3 "Baseline Difference Vectors.py"
    #   Fresh run with explicit overrides:
    #     py -3 "Baseline Difference Vectors.py" --popsize 24 --maxfevals 1200 --log-dir "cmaes_logs/run_01"
    #   Warm-start the free-parameter CMA-ES from a previous result summary:
    #     py -3 "Baseline Difference Vectors.py" --start-from-summary "cmaes_logs/run_01/result_summary.json"
    #   Resume an interrupted CMA-ES run from a saved optimiser checkpoint:
    #     py -3 "Baseline Difference Vectors.py" --resume-state "cmaes_logs/run_01/cmaes_state.pkl" --maxfevals 1200
...
if __name__ == '__main__':
    ...
    #   py -3 "D:\New folder\serotonin\Baseline Difference Vectors.py"
    #   py -3 "D:\New folder\serotonin\Baseline Difference Vectors.py" --popsize 24 --maxfevals 1200 --workers 8
    #   py -3 "D:\New folder\serotonin\Baseline Difference Vectors.py" --log-dir "cmaes_logs\run_01"
    #   py -3 "D:\New folder\serotonin\Baseline Difference Vectors.py" --resume-state "cmaes_logs\run_01\cmaes_state.pkl" --maxfevals 1200
    #   py -3 "D:\New folder\serotonin\Baseline Difference Vectors.py" --start-from-summary "cmaes_logs\run_01\result_summary.json"
    #
    # Optional CLI flags:
